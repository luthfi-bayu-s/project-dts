...
ACCESS_TOKEN = '1126672294271639553-mZ4fg8iiZm9gWkYAjxdqiJB54LgeOZ'
ACCESS_SECRET = 'Dr7CWwzkHt5NsVU7Frv23UZF1zYnCgRFscULxOyQHX0Qq'
CONSUMER_KEY = 'K6OmyNZgrjyuXGXJtw8FGdu5U'
CONSUMER_SECRET = 'OebYSPSxGTrxRVaChGOqoEw2HuYTSCAgWmkJroszRXe6n2PPDP'
...
#                    print(status)
    ...
    with open('stream_tweet.csv', 'w') as f:
        writer = csv.writer(f)
...
stop_words = []
f = open('D:\sentiment analysis\data\stopwords.txt', 'r')
for l in f.readlines():
    stop_words.append(l.replace('\n', ''))

f = open('D:\sentiment analysis\data\stopwords_indonesia.txt', 'r')
for l in f.readlines():
    stop_words.append(l.replace('\n', ''))
...
#streaming 
filter_track = ['indonesia','TIM XXI']
...
df_tws['sentiment'] = pd.Series(anl_tweets(df_tws['clean_vector'], 'indonesia_TIM XXI', True))
